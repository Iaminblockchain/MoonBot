    ...
    if (ammAccount) {
        ...
        if (marketAccount) {
            ...
            return {
                ...
                authority: new PublicKey("5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1"), // Predefined authority address
